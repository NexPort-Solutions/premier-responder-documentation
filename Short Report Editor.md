...
window and is also sent to [CAD](911Adviser%20Acronyms.md) upon receipt\
of the [Get Short Report API command (op code39\)](APCO%20911Adviser%20API.md).

To access the Short Report Editor:

* Log into [Premier Responder  Administrator](911Adviser%20Administrator.md) as Administrator
